...
def build_rb1_world(model, width=20, hwalls=5, dwalls=1):
    ...
    texture_paths, world_info = _build_rb1_default_world(model,width=width, hwalls=hwalls, dwalls=dwalls)
    ...
    model.add_block( (0, bot_height/2.0+0.1, 0, wwalls-2*dwalls, 1, hwalls-2*dwalls, 0.0, 0.0, 0.0), START, block_type='start')

    return texture_paths, world_info

def build_rb1_1wall_world(model, width=20, hwalls=2, dwalls=2):
    """
