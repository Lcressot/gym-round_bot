...
def build_rb1_world(model):
    ...
    texture_path = os.path.dirname(__file__) + '/texture.png'

    GRASS = round_bot_model.tex_coords((1, 0), (0, 1), (0, 0))
    MUD = round_bot_model.tex_coords((0, 1), (0, 1), (0, 1))
    SAND = round_bot_model.tex_coords((1, 1), (1, 1), (1, 1))
    BRICK = round_bot_model.tex_coords((2, 0), (2, 0), (2, 0))
    STONE = round_bot_model.tex_coords((2, 1), (2, 1), (2, 1))
